...
Module Module1
   ...
   "Password=;User ID=Admin;Data Source=db.mdb")
         ...
         Dim daUsers As New OleDbDataAdapter("SELECT ID,fn,ln,cty,st" & _
         ...
         ' below.
         Dim dcaKey() As DataColumn = _
      {dsUsers.Tables(0).Columns("UserID")}
         dsUsers.Tables(0).PrimaryKey = dcaKey

         ' Declare a command builder to create SQL instructions
         ' to create and update records.
         Dim cb As OleDbCommandBuilder = New OleDbCommandBuilder(daUsers)

         ' Update an existing record in the DataSet
         Dim r As DataRow = dsUsers.Tables(0).Rows.Find(8)
         ...
         If Not r Is Nothing Then
            ...
            Console.WriteLine("The record has been updated " & _
            "successfully.")
         Else
