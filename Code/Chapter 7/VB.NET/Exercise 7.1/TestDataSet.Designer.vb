...
Partial Public Class TestDataSet
    ...
    Partial Public Class UserTableDataTable
        ...
        Public Overloads Function AddUserTableRow(ByVal FirstName As String, ByVal LastName As String) As UserTableRow
            Dim rowUserTableRow As UserTableRow = CType(Me.NewRow,UserTableRow)
            rowUserTableRow.ItemArray = New Object() {Nothing, FirstName, LastName}
    ...
    Partial Public Class UserTableRow
        ...
        Public Property LastName() As String
            Get
                ...
                Catch e As System.InvalidCastException
                    Throw New System.Data.StrongTypingException("The value for column 'LastName' in table 'UserTable' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Sub SetLastNameNull()
            Me(Me.tableUserTable.LastNameColumn) = System.Convert.DBNull
        End Sub
    End Class
    ...
    Public Class UserTableRowChangeEvent
        ...
        Public Sub New(ByVal row As UserTableRow, ByVal action As System.Data.DataRowAction)
            MyBase.New
            Me.eventRow = row
...
Namespace TestDataSetTableAdapters
    ...
    Partial Public Class UserTableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me.m_adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserTable] WHERE (([UserID] = @Original_UserID) AND ([FirstNam"& _ 
            ...
            Me.m_adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_UserID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "UserID", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_FirstName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FirstName", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_LastName", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me.m_adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_LastName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.InsertCommand = New System.Data.SqlClient.SqlCommand
            Me.m_adapter.InsertCommand.Connection = Me.Connection
            Me.m_adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserTable] ([FirstName], [LastName]) VALUES (@FirstName, @Last"& _ 
                "Name);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UserID, FirstName, LastName FROM UserTable WHERE (UserID = @@IDEN"& _ 
                "TITY)"
            Me.m_adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me.m_adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@FirstName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FirstName", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me.m_adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@LastName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand
            Me.m_adapter.UpdateCommand.Connection = Me.Connection
            Me.m_adapter.UpdateCommand.CommandText = "UPDATE [dbo].[UserTable] SET [FirstName] = @FirstName, [LastName] = @LastName WHE"& _ 
                "RE (([UserID] = @Original_UserID) AND ([FirstName] = @Original_FirstName) AND (("& _ 
                "@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName"& _ 
                ")));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UserID, FirstName, LastName FROM UserTable WHERE (UserID = @UserID)"& _ 
                ""
            Me.m_adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@FirstName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FirstName", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@LastName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_UserID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "UserID", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_FirstName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FirstName", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_LastName", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_LastName", System.Data.SqlDbType.VarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "LastName", System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me.m_adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@UserID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, 0, 0, "UserID", System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        
        Private Sub InitConnection()
            Me.m_connection = New System.Data.SqlClient.SqlConnection
         Me.m_connection.ConnectionString = Exercise_7_1.Settings.Default.TestConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me.m_commandCollection(0).CommandText = "SELECT UserID, FirstName, LastName FROM dbo.UserTable"
            Me.m_commandCollection(0).CommandType = System.Data.CommandType.Text
        End Sub
        
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As TestDataSet.UserTableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As TestDataSet.UserTableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As TestDataSet.UserTableDataTable = New TestDataSet.UserTableDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        
        Public Overloads Overridable Function Update(ByVal dataTable As TestDataSet.UserTableDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_UserID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Original_UserID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal UserID As Integer) As Integer
            If (FirstName Is Nothing) Then
                Throw New System.ArgumentNullException("FirstName")
            Else
